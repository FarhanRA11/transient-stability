...
\begin{enumerate}
	...
	\item \textit{Settling Time} Osilasi Kecepatan Sudut Rotor, $t_{s,i}$ (s): waktu yang dibutuhkan untuk osilasi kecepatan rotor generator $i$ kembali stabil ke nilai nominal dengan kriteria kestabilan 2\%.
	...
	\item Rasio Redaman Osilasi Kecepatan Rotor, $\zeta_i$ (\%): seberapa cepat osilasi kecepatan rotor generator $i$ teredam. Rasio redaman diestimasi dari persamaan \ref{Eq: zeta}. Rasio redaman merepresentasikan perilaku respon sistem.
		\begin{equation}
			\zeta_i = \frac{4}{\sqrt{(\omega_{d,i} t_{s,i})^2 + 16}} \times 100\%
		\label{Eq: zeta}
		\end{equation}
